...
---
# <a name="scenario-joins-in-apache-hive-leads-to-an-outofmemory-error-in-azure-hdinsight"></a>Escenario: las combinaciones de Apache Hive provocan un error de OutOfMemory en Azure HDInsight
