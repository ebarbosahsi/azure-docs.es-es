...
3. Pruebe la conexión de Private Link del servidor PostgreSQL con cualquier cliente disponible. En el ejemplo siguiente se usa [Azure Data Studio](/sql/azure-data-studio/download) para realizar la operación.
