...
Consulte la guía de soporte técnico [Embedding Organizational Courses (Inserción de cursos de la organización) de](https://support.versal.com/hc/articles/203271866-Embedding-organizational-courses) **Inicio de sesión único de SAML** para obtener instrucciones acerca de cómo insertar un curso de Versal con compatibilidad para el inicio de sesión único de Azure AD. 
