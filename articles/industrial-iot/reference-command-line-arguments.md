---
title: Argumentos de la línea de comandos de Microsoft OPC Publisher
description: En este artículo se proporciona información general de los argumentos de la línea de comandos de OPC Publisher.
author: jehona-m
ms.author: jemorina
...
ms.locfileid: "104787487"
---
# <a name="command-line-arguments"></a>Argumentos de la línea de comandos

En la información que tiene a continuación, verá varios argumentos de la línea de comandos que se pueden usar para establecer la configuración global para OPC Publisher.

## <a name="opc-publisher-command-line-arguments-for-version-25-and-below"></a>Argumentos de la línea de comandos de OPC Publisher para la versión 2.5 y versiones anteriores

* Uso: opcpublisher.exe \<applicationname> [\<iothubconnectionstring>] [\<options>]
    
* applicationname: es el nombre de la aplicación de OPC UA que se va a usar; es necesario el nombre de la aplicación que también se usa para registrar el publicador con este nombre en el registro del dispositivo de IoT Hub.
    
* iothubconnectionstring: es el valor connectionstring de IoT Hub ; opcional. Normalmente, la cadena de conexión del propietario de IoT Hub solo se especifica durante el primer inicio de la aplicación. La cadena de conexión se cifra y se almacena en el almacén de certificados de la plataforma.
En las llamadas posteriores, se lee desde allí y se vuelve a usar. Si especifica la cadena de conexión en cada ejecución, el dispositivo que se creó para la aplicación en el registro del dispositivo de IoT Hub se elimina y se vuelve a crear cada vez.
    
Hay un par de variables de entorno, que se pueden usar para controlar la aplicación:
```
...
## <a name="opc-publisher-command-line-arguments-for-version-26-and-above"></a>Argumentos de la línea de comandos de OPC Publisher para la versión 2.6 y versiones posteriores
```
      --pf, --publishfile=VALUE
                                       the filename to configure the nodes  to publish.
...
Se pueden encontrar más recursos en los repositorios de GitHub:
