...
* Si ha elegido un inquilino de AAD de una lista de inquilinos, reinicie el script y elija otro de la lista.
* Como alternativa, implemente un inquilino de AAD privado en otra suscripción, reinicie el script y selecciónelo para usarlo.
