...
ms.locfileid: "106281680"
---
# <a name="streaming-endpoint-origin-errors"></a>Errores de punto de conexión de streaming (origen)

En este tema se describen los errores que podría recibir desde el [servicio de punto de conexión de streaming](stream-streaming-endpoint-concept.md) de Azure Media Services.
...
- [Concepto: Protección de contenido](drm-content-protection-concept.md)
- [Concepto: Directivas de claves de contenido](drm-content-key-policy-concept.md)
- [Concepto: Directivas de streaming](stream-streaming-policy-concept.md)
- [Ejemplo: Protección con el cifrado AES](drm-playready-license-template-concept.md)
- [Ejemplo: Protección con DRM](drm-protect-with-drm-tutorial.md)

Para obtener instrucciones de filtro, vea:

- [Concepto: manifiestos dinámicos](filters-dynamic-manifest-concept.md)
- [Concepto: filtros](filters-concept.md)
- [Ejemplo: Creación de filtros con las API REST](filters-dynamic-manifest-rest-howto.md)
- [Ejemplo: Creación de filtros con .NET](filters-dynamic-manifest-dotnet-how-to.md)
- [Ejemplo: Creación de filtros con la CLI](filters-dynamic-manifest-cli-how-to.md)

Para obtener ejemplos y artículos en directo, vea:

- [Concepto: Introducción al streaming en vivo](stream-live-streaming-concept.md)
- [Concepto: Objetos LiveEvent y LiveOutput](live-event-outputs-concept.md)
