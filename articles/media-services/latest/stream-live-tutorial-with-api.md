...
- [Cree una cuenta de Media Services](./account-create-how-to.md).<br/>Asegúrese de copiar los detalles de acceso a la API en formato JSON o de almacenar los valores necesarios para conectarse a la cuenta de Media Services en el archivo con formato .env que se usa en este ejemplo.
...
* Para que una dirección URL de ingesta sea predictiva y más fácil de mantener en un codificador en directo basado en hardware, establezca la propiedad "useStaticHostname" en true. Para información detallada, consulte [Direcciones URL de ingesta de objetos LiveEvent](live-event-outputs-concept.md#live-event-ingest-urls).
