...
* [Cifrado dinámico y entrega de claves](drm-content-protection-concept.md)
...
* [Plantilla de licencia de Google Widevine](drm-widevine-license-template-concept.md)
...
* [Plantilla de licencia de PlayReady](drm-playready-license-template-concept.md)
...
![Clave sin cifrado AES](./media/drm-encrypt-content-how-to/aes-clear-key-policy.png)
...
1. Seleccione una **directiva de streaming** que sea adecuada para la **directiva de clave de contenido** que ha configurado.
    ...
    En el tema [Directivas de streaming](stream-streaming-policy-concept.md) se proporcionan detalles sobre qué directiva de streaming coincide con qué directiva de clave de contenido.
...
![Un localizador de streaming](./media/drm-encrypt-content-how-to/multi-drm.png)
