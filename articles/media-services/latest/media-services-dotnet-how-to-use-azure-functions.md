...
description: En este tema se muestra cómo empezar a desarrollar Azure Functions con Media Services v3 mediante Azure Portal.
...
Si desea explorar e implementar instancias de Azure Functions existentes que usan Azure Media Services, visite [Azure Functions de Media Services](https://github.com/Azure-Samples/media-services-v3-dotnet-core-functions-integration). Este repositorio incluye ejemplos que usan Azure Media Services para mostrar flujos de trabajo relacionados con la ingesta directa de contenido desde Blob Storage, la codificación y la escritura de contenido de nuevo en Blob Storage.
...
>[!NOTE]
> Una cuenta de almacenamiento que especifique debe estar en la misma región que la aplicación.
...
1. Elija el lenguaje **C#** y el escenario **Procesamiento de datos**.
1. Elija la plantilla **BlobTrigger**. Esta función se desencadena si se carga un blob en el contenedor **input**. El nombre **input** se especifica en **Path** (Ruta de acceso), en el paso siguiente.
1. Una vez que seleccione **BlobTrigger**, aparecerán algunos controles más en la página.
...
El ejemplo definido en esta sección muestra:

1. Cómo ingerir un recurso en una cuenta de Media Services (copiando un blob en un recurso de AMS)
...
1. Seleccione la cuenta de almacenamiento que ha especificado.
...
Para obtener más detalles y ejemplos y soluciones completos de uso de Azure Functions y Logic Apps con Azure Media Services para crear flujos de trabajo de creación de contenido personalizados, vea [Azure Functions de Media Services](https://github.com/Azure-Samples/media-services-v3-dotnet-core-functions-integration)
