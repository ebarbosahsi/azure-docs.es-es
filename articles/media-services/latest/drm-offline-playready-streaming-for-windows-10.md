...
- [Streaming de FairPlay sin conexión para iOS](drm-offline-fairplay-for-ios-concept.md)
- [Streaming de Widevine sin conexión para Android](drm-offline-widevine-for-android.md)
...
## <a name="background-on-offline-mode-playback"></a>Información general sobre la reproducción en modo sin conexión
