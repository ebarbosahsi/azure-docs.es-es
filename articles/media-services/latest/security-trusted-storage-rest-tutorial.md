...
Si no sabe cómo obtener el identificador de inquilino y el identificador de suscripción, consulte [Cómo buscar el identificador de inquilino](setup-azure-tenant-how-to.md) y [Búsqueda del identificador de inquilino](setup-azure-tenant-how-to.md).
...
[Cómo crear un recurso](asset-create-asset-how-to.md)
