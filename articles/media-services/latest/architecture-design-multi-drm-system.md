...
| **macOS** | FairPlay | Safari para FairPlay (desde Safari 9 y versiones superiores en macOS X 10.11 y El Capitan)|
| **tvOS** | FairPlay | |
...
![Subsistema DRM con CENC](./media/architecture-design-multi-drm-system/media-services-generic-drm-subsystem-with-cenc.png)
...
![CENC en Media Services](./media/architecture-design-multi-drm-system/media-services-cenc-subsystem-on-AMS-platform.png)
...
* Agregue permisos a la aplicación en Azure AD en la pestaña **Configurar** de la aplicación. Los permisos son necesarios para cada aplicación, tanto para las versiones locales como implementadas.
    ...
    ![Permisos](./media/architecture-design-multi-drm-system/media-services-perms-to-other-apps.png)
...
![Cuenta uno de dominio de inquilino de Azure AD personalizado](./media/architecture-design-multi-drm-system/media-services-ad-tenant-domain1.png)
...
![Cuenta dos de dominio de inquilino de Azure AD personalizado](./media/architecture-design-multi-drm-system/media-services-ad-tenant-domain2.png)

**Cuenta de Microsoft**: Página de inicio de sesión de la cuenta de Microsoft para los consumidores.

![Cuenta tres de dominio de inquilino de Azure AD personalizado](./media/architecture-design-multi-drm-system/media-services-ad-tenant-domain3.png)
...
![Uso de EME para PlayReady](./media/architecture-design-multi-drm-system/media-services-eme-for-playready1.png)
...
![Complementos de reproductor para PlayReady](./media/architecture-design-multi-drm-system/media-services-eme-for-playready2.png)
...
![Uso de EME para Widevine](./media/architecture-design-multi-drm-system/media-services-eme-for-widevine1.png)

Widevine no impide la realización de capturas de pantalla de vídeo protegido.

![Complementos de reproductor para Widevine](./media/architecture-design-multi-drm-system/media-services-eme-for-widevine2.png)
...
![Usuarios no autorizados](./media/architecture-design-multi-drm-system/media-services-unentitledusers.png)
...
![Servicio de token de seguridad personalizado con una clave simétrica](./media/architecture-design-multi-drm-system/media-services-running-sts1.png)
...
![Servicio de token de seguridad personalizado con una clave asimétrica](./media/architecture-design-multi-drm-system/media-services-running-sts2.png)
