...
- El [punto de conexión de streaming](stream-streaming-endpoint-concept.md) `hostname` y la dirección URL de streaming se mantienen independientemente de si habilita CDN.
...
* Asegúrese de revisar el documento [punto de conexión de streaming (origen)](stream-streaming-endpoint-concept.md).
