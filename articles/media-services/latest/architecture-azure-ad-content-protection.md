...
* Las [directivas de clave de contenido](drm-content-key-policy-concept.md) de AMS mediante la API de AMS v3, Azure Portal o la [herramienta Azure Media Services Explorer (AMSE)](https://github.com/Azure/Azure-Media-Services-Explorer)
...
Consulte [Diseño del sistema de protección de contenido con DRM múltiple con control de acceso](./architecture-design-multi-drm-system.md) para más información sobre el subsistema.
...
Se aplica la configuración de la [directiva de clave de contenido](drm-content-key-policy-concept.md) y las [directivas de streaming](stream-streaming-policy-concept.md) para DRM y AES-128.  Cambie el valor de `ContentKeyPolicyRestriction` en la directiva de clave de contenido.
...
> [Inicio rápido: Cifrado del contenido](drm-encrypt-content-how-to.md)
