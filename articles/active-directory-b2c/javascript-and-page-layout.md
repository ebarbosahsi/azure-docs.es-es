...
- Marcos de JavaScript:
    - Azure AD B2C usa una [versión específica de jQuery](page-layout.md#jquery-version). No incluya otra versión de jQuery. Usar más de una versión en la misma página provoca problemas.
