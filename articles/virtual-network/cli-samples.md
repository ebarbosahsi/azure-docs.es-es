...
|[Tutorial: Creación y prueba de una puerta de enlace de NAT: CLI de Azure](./tutorial-create-nat-gateway-cli.md)|Cree y valide una puerta de enlace NAT mediante una máquina virtual de origen y de destino. |