...
- Para restaurar las VM con discos administrados mediante PowerShell, proporcione el parámetro adicional ***TargetResourceGroupName*** para especificar el grupo de recursos en el que se restaurarán los discos administrados. [Obtenga más información aquí](./backup-azure-vms-automation.md#restore-managed-disks).
