...
|**Entrada**  |**Descripción**  |
|---------|---------|
| API |Elija el tipo de API de su cuenta. |
...
|Datos totales almacenados en el almacén analítico | Esta opción se muestra si **activa** la opción **Use Analytical Store** (Usar el almacén analítico). Representa los datos totales estimados almacenados (GB) en el almacén analítico en una sola región.  |
|Tamaño del elemento|El tamaño estimado del elemento de datos (por ejemplo, un documento), que va de 1 KB a 2 MB. |
|Lecturas/s por región|Número de operaciones de lectura esperadas por segundo. |
|Creaciones/s por región|Número de operaciones de creación esperadas por segundo. |
|Actualizaciones/s por región|Número de operaciones de actualización esperadas por segundo. |
|Eliminaciones/s por región|Número de operaciones de eliminación esperadas por segundo. |

Después de rellenar los detalles necesarios, seleccione **Calcular**. La pestaña **Cost Estimate** (Estimación del costo) muestra el costo total del almacenamiento y el rendimiento aprovisionado. Puede expandir el vínculo **Mostrar detalles** de esta pestaña para obtener el desglose del rendimiento necesario para distintas solicitudes de CRUD. Cada vez que cambie el valor de cualquier campo, seleccione **Calcular** para volver a calcular el costo estimado.

:::image type="content" source="./media/estimate-ru-with-capacity-planner/basic-mode.png" alt-text="Modo básico de Capacity Planner" border="true":::
...
:::image type="content" source="./media/estimate-ru-with-capacity-planner/advanced-mode.png" alt-text="Modo avanzado de Capacity Planner" border="true":::
