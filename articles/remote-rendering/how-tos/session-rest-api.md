...
También proporcionamos SDK para [.NET](https://github.com/Azure/azure-sdk-for-net/blob/master/sdk/remoterendering/Azure.MixedReality.RemoteRendering/README.md) y [Java](https://github.com/Azure/azure-sdk-for-java/blob/master/sdk/remoterendering/azure-mixedreality-remoterendering/README.md).
...
> [!IMPORTANT]
> Se necesita un SDK del entorno de ejecución de Enrutamiento de solicitud de aplicaciones para que un dispositivo cliente se conecte a una sesión de representación. Estos SDK están disponibles en [.NET](/dotnet/api/microsoft.azure.remoterendering) y [C++](/cpp/api/remote-rendering/). Además de conectarse al servicio, estos SDK también se pueden usar para iniciar y detener sesiones.
